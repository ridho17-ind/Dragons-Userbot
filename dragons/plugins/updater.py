...
from dragons import HEROKU_APP, UPSTREAM_REPO_URL, drgub
...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        return await event.respond(
            f"do `{cmdhd}update deploy` to update the Dragons-Userbot"
        )
...
@drgub.drg_cmd(
    ...
    info={
        "header": "To update to baddrg( for extra masala and gali).",
        "usage": "{tr}baddrg",
    },
)
async def variable(var):
    "To update to baddrg( for extra masala and gali)."
